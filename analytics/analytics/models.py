...
class StudentAnalytics(models.Model):
    ...
    def __str__(self):
        """
        Return a string representation of the StudentAnalytics instance.

            This method generates a string that includes the student ID,
            which helps in identifying the specific StudentAnalytics instance.

            Returns:
                str: A formatted string containing the student ID.
        """
